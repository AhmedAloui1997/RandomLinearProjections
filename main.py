...
if __name__ == "__main__":
    ...
    parser.add_argument('--LossFunction', type=str, default='MSE', help='Loss function (MSE, MSE_L2, or RLP)')
    parser.add_argument('--TrainSize', type=float, default=1000, help="Training dataset size", required=False)
